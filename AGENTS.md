# ai-assisted-weekly-cash-flow-reporting

AI-assisted weekly cash flow reporting tool that consolidates Finance data, updates a 4-week forecast, flags risks and variances, and generates a management-ready report — replacing hours of manual spreadsheet work.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "301182535+petertham88@users.noreply.github.com"
  git config user.name "petertham88"
  ```
